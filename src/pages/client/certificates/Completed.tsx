  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        const completedCerts = certs.filter((cert: Certificate) => cert.status === 'Completed');
        setCertificates(completedCerts);
      } catch (err: any) {
        ...
        <div className="row align-items-center">
          <div className="col-md-12">
            <Title level={2} className="banner-title">
              <FileTextOutlined className="me-2" /> Completed Certificates
            </Title>
            <Text className="banner-subtitle">
              View and download your completed certificates
            </Text>
          </div>
        </div>
      </div>
            ...
            {loading ? (
              ...
              <div className="empty-state text-center py-5">
                <Empty
                  ...
                  description={<Text className="text-muted">No completed certificates found</Text>}
                />
                <div className="mt-4">
                  <button 
